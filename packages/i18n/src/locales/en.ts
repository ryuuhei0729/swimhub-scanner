...
const en: TranslationShape = {
  ...
  auth: {
    ...
    emailLoginScreen: {
      ...
      resetEmailRequiredTitle: "Email Address Required",
      resetEmailRequired: "Please enter the email address to send the password reset link to",
      resetSuccessTitle: "Email Sent",
      resetSuccessMessage:
        "If an account exists for that email address, we've sent a password reset link. Please follow the instructions in the email.",
      resetFailed: "Failed to send the password reset email. Please try again later",
    },
    emailSignupScreen: {
    ...
    errors: {
      ...
      supabaseNotConfigured: "Supabase client is not initialized",
      oauthUrlFailed: "Failed to generate the authentication URL",
      tokenMissing: "Failed to obtain an authentication token",
      authDismissed: "Authentication was dismissed",
      authFailed: "Authentication failed",
      appleIosOnly: "Sign in with Apple is only available on iOS",
      appleTimeout: "Authentication timed out. Please try again",
      appleUnavailableOnDevice: "Sign in with Apple is not available on this device",
      appleNonceFailed: "Failed to initialize authentication. Please restart the app and try again",
      appleTokenMissing: "Failed to obtain an Apple authentication token. Please try again",
      appleCancelled: "Authentication was cancelled. Please try again",
      appleRequestFailed: "Sign in with Apple failed. Please wait a moment and try again",
      deepLinkFailed: "Failed to process the authentication link. Please try again.",
      urlParseFailed: "Failed to parse the URL",
    },
  },
  scanner: {
    heroTitle: "SwimHub Scanner",
    heroSubtitle: "Analyze handwritten time sheets with AI",
    heroMessage: "Photograph your time sheet and AI will automatically read your times",
    ...
    templateFileName: "Team Time Sheet Template",
    output: "Export",
    ...
    noSwimmersTitle: "No swimmers",
    noSwimmersMessage: "You've removed all swimmers. Please start a new scan.",
    ...
    statusFetchError: "Failed to load your usage status. Please check your connection.",
    statusFetchRetry: "Tap to retry →",
  ...
  paywall: {
    ...
    restoreUnavailableMessage: "This feature is unavailable right now. Please try again later.",
