...
export function ExportButtons({ data }: ExportButtonsProps) {
  ...
  const exportImage = useCallback(async () => {
    ...
    const tableWidth =
      ...
      colWidths.stat * 3;
    const tableHeight = menuHeight + headerHeight + data.swimmers.length * rowHeight + footerHeight;
    ...
    ctx.textAlign = "right";
    ctx.fillText("Generated by SwimHub Scanner", startX + tableWidth, y + footerHeight - 8);
